...
|---|---|---|---|
| 1 | SQL Injection | `routes/auth.js` (login) | Username concatenated directly into the SQL string instead of using a placeholder. Try `admin' -- ` as the username to bypass the password check. |
